        ...
        <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
        	<div class="panel panel-default">
        		<div class="panel-heading">
			    		<h3 class="panel-title">Bienvenido Por Favor Registrese <small>Solo Aqui!</small></h3>
			 			</div>
			    		...
			    		<form role="form">
			    			...
			    			<div class="form-group">
			    				<input type="number" name="ci" id="txt_ci" class="form-control input-sm" placeholder="CI">
			    			</div>
